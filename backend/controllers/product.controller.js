...
export const getProduct = async (req, res) => {
  ...
  try {
    ...
    const productsWithFullImagePath = products.map((product) => ({
      ...product.toObject(),
      image: `https://chuz1qpd.up.railway.app/assets/${product.image}`,
    }));
...
export const createProduct = async (req, res) => {
  ...
  try {
    ...
    const productWithFullImagePath = {
      ...
      image: `https://chuz1qpd.up.railway.app/assets/${populatedProduct.image}`,
    };
  ...
  try {
    ...
    const productWithFullImagePath = {
      ...
      image: updatedProduct.image
        ? `https://chuz1qpd.up.railway.app/assets/${updatedProduct.image}`
        : null,
    };
...
export const getRelatedProducts = async (req, res) => {
  try {
    ...
    const productsWithFullImagePath = relatedProducts.map((relatedProduct) => ({
      ...
      image: `https://chuz1qpd.up.railway.app/assets/${relatedProduct.image}`,
    }));
