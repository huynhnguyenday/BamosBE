...
export const getProduct = async (req, res) => {
  ...
  try {
    ...
    const productsWithFullImagePath = products.map((product) => ({
      ...product.toObject(),
      image: `https://bamosbe.com/assets/${product.image}`,
    }));
...
export const createProduct = async (req, res) => {
  ...
  try {
    ...
    const productWithFullImagePath = {
      ...
      image: `https://bamosbe.com/assets/${populatedProduct.image}`,
    };
  ...
  try {
    ...
    const productWithFullImagePath = {
      ...
      image: updatedProduct.image
        ? `https://bamosbe.com/assets/${updatedProduct.image}`
        : null,
    };
...
export const getRelatedProducts = async (req, res) => {
  try {
    ...
    const productsWithFullImagePath = relatedProducts.map((relatedProduct) => ({
      ...
      image: `https://bamosbe.com/assets/${relatedProduct.image}`,
    }));
